#' @title Plot RSS_seasonally for TCH
#' @export
#' @author Julie W. Turner, Alec L. Robitaille
plot_rss_seasonal_tch <- function(rss, theme) {
...
ggplot(data, aes(x, rss)) +
		...
		ggtitle(paste0('RSS compared to median distance to TCH - ', data$season))

ggsave(
	filename = paste0('graphics/rss_tch_', i, '.png'),
	width = 10,
	height = 10,
	dpi = 320
)
